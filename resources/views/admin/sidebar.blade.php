<div class="flex h-screen flex-col justify-between border-e bg-white">
    <div class="px-4 py-6">
        <span class="items-center space-x-2 h-10 w-32 place-content-center rounded-lg bg-gray-100 text-xs text-gray-600 flex">
        ...
        <ul class="mt-6 space-y-1">
            <x-layout.sidebar-item route="{{ route('admin.dashboard') }}" label="Overview" />
    ...
    <x-layout.sidebar-profile name="{{ Auth::user()->NamaLengkap }}" email="{{ Auth::user()->email }}" image="https://images.unsplash.com/photo-1600486913747-55e5470d6f40?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80" />
</div>
